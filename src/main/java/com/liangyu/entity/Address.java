...
public class Address {
		...
		public Address( int user_id, String receiver_name, String receiver_phone, String receiver_mobile,
		...
		public String toString() {
			return "Address [id=" + id + ", user_id=" + user_id + ", receiver_name=" + receiver_name
					+ ", receiver_phone=" + receiver_phone + ", receiver_mobile=" + receiver_mobile
