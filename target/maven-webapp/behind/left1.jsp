    ...
    <TD vAlign=top bgColor=#799ae1>
      ...
      <TABLE cellSpacing=0 cellPadding=0 width=158 align=center>
        ...
        <TR>
          ...
          onmouseout="this.className='menu_title';" background="" 
            ...
            <B><a href="Logout">退出登录</a></B></SPAN></TD>
        </TR>
        <TR>
          <TD class=menu_title onMouseOver="this.className='menu_title2';" 
          onmouseout="this.className='menu_title';" background="" 
            ...
            <TD id=submenu2><DIV class=sec_menu style="WIDTH: 158px">
                <TABLE cellSpacing=0 cellPadding=0 width=135 align=center>
                  <TBODY>
                    ...
                    <TR>
                      <TD height=20><a href="ProductReadservelt" target="servelt">商品浏览|修改</a></TD>
                    </TR>
                    <TR>
                      <TD height=20><a href="ProductAddServlet" target="servelt">商品添加</a></TD>
                    </TR>
                    <TR>
                      <TD height=20><a href="ProduceSearch.asp" target="mainFrame">商品搜索</a></TD>
                    </TR>
                    <TR>
                      <TD height=20><a href="Rservelt" target="servelt">商品类别|添加</a></TD>
                    </TR>
                  </TBODY>
                </TABLE>
            </DIV>
	  ...
	  <TABLE cellSpacing=0 cellPadding=0 width=158 align=center>
        ...
        <TR>
          ...
          onmouseout="this.className='menu_title';" 
          background=left.files/admin_left_2.gif height=25><SPAN>地址管理</SPAN> 
          </TD>
        </TR>
        <TR>
          <TD id=submenu1>
            ...
            <TABLE cellSpacing=0 cellPadding=0 width=135 align=center>
              ...
              <TR>
                <TD height=20><a href="UserShow.asp" target="mainFrame">地址显示|修改</a></TD>
              </TR>
              <TR>
                <TD height=20><a href="UserAdd.asp" target="mainFrame">地址添加</a></TD>
              </TR>
              <TR>
