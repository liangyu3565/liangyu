...
<td>省份：</td>
<td>
<select name="receiver_province" value="${receiver_province}">
<option>北京</option>
<option>天津</option>
</select>
...
<td>城市：</td>
<td>
<select name="receiver_city" value="${address.receiver_city}">
<option>北京市</option>
<option>天津市</option>
</select>
</td>
...
<td>区县：</td>
<td>
<select name="receiver_district" value="${address.receiver_district}">
<option>津南区</option>
<option>南开区</option>
</select>
